                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <label class="radio-inline">
                                <input name="status" type="radio" value="active" <?php if(!isset($admin) || $admin->status == 'active'){ echo 'checked="checked"'; } ?>>
                                是
                            </label>
                            <label class="radio-inline">
                                <input name="status" type="radio" value="inactive" <?php if(isset($admin) && $admin->status == 'inactive'){ echo 'checked="checked"'; } ?>>
                                否
                            </label>
                        </div>
                    </div>

        ...
        <div class="title-env">
          ...
          <div class="breadcrumb-env">
            ...
            <ol class="breadcrumb bc-1">
              ...
              <li class="active"><strong>添加用户域名</strong></li>
            </ol>
            ...
            <div class="panel-body">
                <form role="form" action="" method="post" class="form-horizontal" id="sForm">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <span style="color: #f00;">注意：添加用户域名必须先在域名列表中添加</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="domain_name" required="required" placeholder="请输入域名" value="">
                        </div>
                    </div>
                    <div class="form-group-separator"></div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="domain_price" required="required" placeholder="请输入域名价格" value="0">
                        </div>
                    </div>
                    <div class="form-group-separator"></div>
                    <div class="form-group">
...
function form_submit(){
    ...
    $("#sForm").ajaxForm({
        url:'/admin/Index_controller/user_domain_add_do',
        type:'post',
        dataType:'json',
        ...
        success:function (data) {
            if(data.state == "success"){
                location.href = '<?php echo base_url() ?>admin/domain_list?user_id=<?php echo $user_id; ?>';
            }else{
